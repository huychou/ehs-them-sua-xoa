...
namespace EHS.WebAPI.Controller
{
    ...
    public class VoucherController : ApiController
    {
        ...
        [Route("DetailExport")]
        [HttpGet]
        public IHttpActionResult DetailExport()
        {
            try
            {
                var dt = oAC.ExecuteStoredProcedure("GetVoucherDetail",
                     new string[] {}, new object[] {}).Tables[0];
                return Ok(dt);
            }
            catch (Exception e)
            {
        ...
        [Route("ExportXLSData")]
        [HttpGet]
        public IHttpActionResult ExportXLSData(string VoucherID, DateTime? dateFrom, DateTime? dateTo, string ProcessComp, string DepartProcess, string InternalPhone, string VoucherNumber, string DepartReq, string Status, string userID, int isCheck, string lang)
        {
            var dt = oAC.ExecuteStoredProcedure("ExportXLSData"
                , new string[] { "VoucherID", "From", "To", "ProcessComp", "DepartProcess", "InternalPhone", "VoucherNumber", "DepartReq", "Status", "CheckMyOwn", "UserID","Lang" }
                , new object[] { VoucherID, dateFrom, dateTo, ProcessComp, DepartProcess, InternalPhone, VoucherNumber, DepartReq, Status, isCheck, userID, lang}
                ).Tables[0];
